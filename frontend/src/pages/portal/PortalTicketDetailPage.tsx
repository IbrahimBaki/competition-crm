...
export function PortalTicketDetailPage() {
  ...
  const messagesQuery = useQuery({ queryKey: ['portal', 'ticket', id, 'messages'], queryFn: () => apiRequest<Message[]>({ url: `/portal/tickets/${id}/messages`, method: 'GET', params: { per_page: 100 } }), enabled: Boolean(id) });
