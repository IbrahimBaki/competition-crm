...
export function TicketAssignmentControl({
    ...
    const transferAgent = useTicketMutation(
        useTransferTicketToAgent,
        ticket.id,
        {
    ...
    const transferDepartment = useTicketMutation(
        useTransferTicketToDepartment,
        ticket.id,
        {
    ...
    const conflict =
        ...
        assign.conflict ??
        unassign.conflict ??
        transferAgent.conflict ??
        transferDepartment.conflict;
    const reloadLatest =
        claim.reloadLatest ||
        assign.reloadLatest ||
        unassign.reloadLatest ||
        transferAgent.reloadLatest ||
        transferDepartment.reloadLatest;
    ...
    const anyPending =
        ...
        transferDepartment.isPending;

    return (
        <div className={styles.stack}>
            {conflict && (
                <ConflictBanner error={conflict} onReload={reloadLatest} />
            )}
            ...
            <ActionGuard permission={PERMISSIONS.TICKETS_ASSIGN}>
                <div className={styles.actions}>
                    <input
                        ...
                        value={assigneeUuid}
                        onChange={(event) =>
                            setAssigneeUuid(event.target.value)
                        }
                    ...
                    <button
                        ...
                        onClick={() =>
                            assign.mutate({
                                ticket: ticket.id,
                                assigneeUuid: assigneeUuid.trim(),
                                version: ticket.version,
                            })
                        }
            ...
            <ActionGuard permission={PERMISSIONS.TICKETS_TRANSFER_AGENT}>
                <div className={styles.actions}>
                    <input
                        ...
                        value={transferUuid}
                        onChange={(event) =>
                            setTransferUuid(event.target.value)
                        }
                        placeholder={t("tickets.filters.uuid_placeholder")}
                        className={styles.control}
                        disabled={anyPending}
            ...
            <ActionGuard permission={PERMISSIONS.TICKETS_TRANSFER_DEPARTMENT}>
                <div className={styles.stack}>
                    <div className={styles.actions}>
                        ...
                        >
                            <option value="">
                                {t("tickets.assignment.choose_department")}
                            </option>
                    ...
                    <label className={styles.label}>
                        <input
                            ...
                            onChange={(event) =>
                                setKeepAssignee(event.target.checked)
                            }
                        />
