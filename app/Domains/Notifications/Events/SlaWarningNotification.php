...
final readonly class SlaWarningNotification implements NotifiableEvent, ShouldDispatchAfterCommit
{
    private string $id;
    ...
    public function __construct(
        ...
        private int $minutesUntilBreach,
    ...
    {
        return NotificationEventType::SlaWarning;
    }
    ...
    public function payload(): array
    {
        return [
            ...
            'minutes_until_breach' => $this->minutesUntilBreach,
        ];
    }
}
