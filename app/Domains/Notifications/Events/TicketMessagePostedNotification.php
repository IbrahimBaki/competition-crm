...
final readonly class TicketMessagePostedNotification implements NotifiableEvent, ShouldDispatchAfterCommit
{
    private string $id;
    ...
    {
        return NotificationEventType::TicketMessagePosted;
    }
