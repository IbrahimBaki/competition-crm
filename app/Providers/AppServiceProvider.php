...
use App\Domains\Channels\Chat\Policies\ChatSessionPolicy;
...
use App\Domains\Ticketing\Policies\TicketSavedViewPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(TicketSavedView::class, TicketSavedViewPolicy::class);
